...
function App() {
  ...
  // const mbio = ()=>{
  //   const BIO = document.querySelectorAll('.mentor-bio');
  //   BIO.style.transition = 'all 0.5s ease-in-out';
